...
function answervalue() {
  ...
  buttons.forEach((el) => {
    el.addEventListener("click", (event) => {
      ...
      if (correctAnswerArray.includes(el.innerText)) {
        ...
        elementP.innerText =
          document.getElementById("QuestionCounterDiv").childElementCount + 1;
  ...
  if (document.getElementById("QuestionCounterDiv").childElementCount === 20) {
    //<-------pakeisti kiek klausimu reikia atsakyti
